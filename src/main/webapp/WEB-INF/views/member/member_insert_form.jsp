		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
			   ...
			   <table class="table">
			      ...
			      <tr>
			         <th>이름</th>
			         <td><input  class="form-control" required="required" name="mem_name" style="width: 30%;"></td>
			      </tr>
			      ...
			      <tr>
			         <th>비밀번호</th>
			         <td><input  class="form-control" required="required" type="password"  name="mem_pwd" style="width: 30%;"></td>
			      </tr>
			      
			      <!-- 이메일 -->
			      <tr>
			         <th>이메일</th>
			         <td><input  class="form-control"  required="required"  type="email" name="mem_email" style="width: 30%;"></td>
			      </tr>
			      ...
			      <tr>
			         <td colspan="2" align="center">
			             <input class="btn btn-success" type="button"  value="목록보기" onclick="location.href='../board/list.do'">
